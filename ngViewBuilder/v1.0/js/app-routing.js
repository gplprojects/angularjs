...
window[appName].config(['$stateProvider', '$urlRouterProvider', function ($stateProvider, $urlRouterProvider) {
    ...
    $stateProvider
        .state('home', {
            ...
            resolve: {
                load: ['$ngViewLoader', function ($ngViewLoader) {
                    return $ngViewLoader.load('home', '../controllers/home', 'homeController', true);
                }]
            }
        })
		...
		.state('home.list', {
		    ...
		    resolve: {
		        load: ['$ngViewLoader', function ($ngViewLoader) {
		            return $ngViewLoader.load('list', '../controllers/list', 'listController');
		        }]
		    }
		})
		.state('home.detail', {
		    ...
		    resolve: {
		        load: ['$ngViewLoader', function ($ngViewLoader) {
		            return $ngViewLoader.load('detail', '../controllers/detail', 'detailController');
		        }]
		    }
		});
}]);
