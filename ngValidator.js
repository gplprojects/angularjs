    ...
    .directive('valuePatterns', ['$parse', function($parse) {
	    return {
			...
			link: function (scope, elm, attr, ctrl) {
				...
				scope.notmatch = function(v, c, el, at) {
					return v != scope.$eval(at['notmatch']);
				}
    			...
    			try {	
    				...
    				scope[formName].isValid = function() {
	    				for(var el in this) {
	    					...
	    					if(angular.isFunction(this[el].isValid) && !this[el].isForm)
	    						this[el].isValid()
	    				}
	    				return this.$valid;
	    			};
	    			...
	    			scope[formName].clearErrors = function() {
	    				for(var el in this) {
	    					...
	    					if(angular.isFunction(this[el].clearErrors))
	    						this[el].clearErrors()
	    				}
	    				return this.$valid;
	    			};
